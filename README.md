...
- **Be a coding agent** - I doubt that it is possible to do this with <1b LLM models and there is already a great coding agent out there called [SmallCode](https://github.com/Doorman11991/smallcode) which was build with small models (>8b) in mind
